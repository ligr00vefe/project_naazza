...
abstract final class TrackingCatalog {
  ...
  static const conditions = <ConditionDefinition>[
    ConditionDefinition(
      key: 'diabetes',
      label: '혈당 관리',
      subtitle: '혈당과 탄수화물, 식사 리듬 중심',
      icon: Icons.water_drop_outlined,
      metricKeys: ['blood_glucose', 'carbohydrate', 'meal_time', 'small_meal'],
    ),
    ConditionDefinition(
      key: 'ibd',
      label: '장 컨디션 관리',
      subtitle: '배변과 편안한 장 상태 중심',
